...
var LambdaClient = /** @class */ (function () {
    function LambdaClient(configuration) {
        ...
        this.config = __aws_sdk_config_resolver.resolveConfiguration(configuration, LambdaConfiguration_1.configurationProperties, this.middlewareStack);
    ...
    LambdaClient.prototype.send = function (command, cb) {
